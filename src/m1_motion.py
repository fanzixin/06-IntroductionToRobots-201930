...
def run_test_go(robot):
    ...
    # DONE: 3. Implement this.
    # -------------------------------------------------------------------------
    robot.drive_system.left_motor.turn_on(-70)
    robot.drive_system.right_motor.turn_on(70)
    time.sleep(2)
...
def challenge1(robot):
    ...
    go_secondsf = 4
    go(robot, turn, 50, -50)
    go(robot, go_seconds, 50, 50)
    go(robot, turn * 2.25, -50, 50)
    go(robot, go_seconds + 0.9, 50, 50)
    go(robot, turn * 2.5, 50, -50)
    go(robot, go_seconds + 2, 50, 50)
    go(robot, turn * 2, -50, 50)
    go(robot, go_secondsf, 50, 50)
